...
const Register = () => {
  ...
  const roleOptions = [
    ...
    },
    {
      ...
      label: 'Agente',
      description: 'Sou profissional imobiliario',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="min-h-screen bg-sand-50 flex pt-28 pb-12">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-portuguese-pattern relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-olive-700/90 via-olive-800/85 to-terracotta-800/90"></div>
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
          <div className="max-w-md text-center">
            ...
            <p className="text-xl text-sand-100 mb-8">
              Junte-se a milhares de portugueses a encontrar o lar perfeito
            </p>
            <div className="space-y-4 text-sand-200">
              <div className="flex items-center justify-center gap-3">
                ...
                <span>Registo gratuito e rapido</span>
              </div>
              <div className="flex items-center justify-center gap-3">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span>Acesso a propriedades exclusivas</span>
              </div>
              <div className="flex items-center justify-center gap-3">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-4 sm:px-6 lg:px-12 overflow-y-auto">
        <div className="sm:mx-auto sm:w-full sm:max-w-lg">
          ...
          <p className="mt-2 text-center text-sm text-stone-600">
            Ou{' '}
            <Link to="/login" className="font-medium text-terracotta-600 hover:text-terracotta-500 transition-colors">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <label
                      ...
                      className={`
                        ...
                        ${formData.role === option.value
                          ...
                          : 'border-stone-200 bg-white hover:border-terracotta-300 hover:bg-sand-50'
                        }
                      `}
                    >
                      <input
                        ...
                        className="sr-only"
                      />
                      <span className={`mb-2 ${formData.role === option.value ? 'text-terracotta-600' : 'text-stone-400'}`}>
                        {option.icon}
                      </span>
                      <span className={`text-sm font-medium ${formData.role === option.value ? 'text-terracotta-700' : 'text-stone-700'}`}>
                        {option.label}
                      </span>
                      <span className="text-xs text-stone-500 text-center mt-1 hidden sm:block">
                        {option.description}
                      </span>
                      {formData.role === option.value && (
                        <span className="absolute top-2 right-2 w-2 h-2 bg-terracotta-500 rounded-full"></span>
                      )}
                    </label>
                  ))}
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="phone" className="block text-sm font-medium text-stone-700">
                    Telefone <span className="text-stone-400">(opcional)</span>
                  </label>
                  <input
                    id="phone"
                    name="phone"
              ...
              <div className="flex items-start">
                <input
                  ...
                  type="checkbox"
                  required
                  className="h-4 w-4 text-terracotta-600 focus:ring-terracotta-500 border-stone-300 rounded mt-0.5 transition-colors"
                />
                <label htmlFor="terms" className="ml-2 block text-sm text-stone-600">
                  Concordo com os{' '}
                  <a href="#" className="text-terracotta-600 hover:text-terracotta-500 transition-colors">
                    Termos de Servico
                  </a>{' '}
                  e{' '}
                  <a href="#" className="text-terracotta-600 hover:text-terracotta-500 transition-colors">
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-stone-500">Ja tem conta?</span>
                </div>
              </div>
