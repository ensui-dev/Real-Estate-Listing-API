...
A comprehensive full-stack RESTful API and Content Management System for the Portuguese real estate market, built with the MERN stack (MongoDB, Express, React, Node.js).
...
- Contact: support@lusitanestate.pt
...
**LusitanEstate - Built with care for the Portuguese real estate market**
